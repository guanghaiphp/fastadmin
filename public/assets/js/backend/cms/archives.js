            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'channel.name', title: __('Channel'), formatter: function (value, row, index) {
                        ...
                        {field: 'updatetime', title: __('Updatetime'), sortable: true, formatter: Table.api.formatter.datetime},
